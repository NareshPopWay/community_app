...
import 'package:community_app/controllers/Request_controller/scholarship_request_controller.dart';
...
class ScholarshipRequestBinder extends Bindings {
  @override
  void dependencies() {
    ...
    Get.lazyPut(() => ScholarshipRequestController());
