...
import 'package:community_app/models/feedback_model.dart';
...
class FeedBackController extends GetxController {
  ...
  Future<void> getFeedBack() async {
    ...
    var feedResponse = await APIProvider().getFeedBack(token.value);
    if (feedResponse.isNotEmpty) {
      feedBackList.addAll(feedResponse);
      isLoading.value = false;
    }
    else {
      isLoading.value = false;
