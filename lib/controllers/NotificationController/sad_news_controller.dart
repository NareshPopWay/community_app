...
class SadNewsController extends GetxController {

  RxBool isLoading = false.obs;
  RxString token="".obs;
  RxList<NotificationModel> sadNewsList = <NotificationModel>[].obs;
  ...
  Future<void> getSadNews() async {
    ...
    var sadNewsResponse = await APIProvider().getSadNews(token.value);
    if (sadNewsResponse.isNotEmpty) {
      sadNewsList.addAll(sadNewsResponse);
      isLoading.value = false;
    }
    else {
      isLoading.value = false;
