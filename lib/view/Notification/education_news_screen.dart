...
import '../../controllers/NotificationController/education_news_controller.dart';

class EducationNewsScreen extends GetView<EducationNewsController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
        ...
        body:controller.isLoading.value
            ...
            : controller.EduNewsList.isEmpty
            ? Center(
          child: Text(
            'EducationNews Not Available',
            style: TextStyle(
              color: Colors.black,
            ...
            itemCount: controller.EduNewsList.length,
            ...
            itemBuilder: (BuildContext ctx, index) {
              return  Padding(
                ...
                child: Card(
                  ...
                  child: InkWell(
                    onTap: () {
                      Get.toNamed(Routes.notificationDetails,arguments:controller.EduNewsList[index]);
                    },
                    child: Row(
                      children: <Widget>[
                        Expanded(
