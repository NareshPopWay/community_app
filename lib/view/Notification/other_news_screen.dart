...
class OtherNewsScreen extends GetView<OtherNewsController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
      ...
      body: controller.isLoading.value
          ...
          : controller.otherNewsList.isEmpty
          ? Center(
        child: Text(
          'OtherNews Not Available',
          style: TextStyle(
            color: Colors.black,
          ...
          itemCount: controller.otherNewsList.length,
          ...
          itemBuilder: (BuildContext ctx, index) {
            return  Padding(
              ...
              child: Card(
                ...
                child: InkWell(
                  onTap: () {
                    Get.toNamed(Routes.notificationDetails,arguments:controller.otherNewsList[index]);
                  },
                  child: Row(
                    children: <Widget>[
                      Expanded(
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(
                                          BaseUrl.ImageURL +
                                              controller.otherNewsList[index]
                                                  .fileData,
                                        ),
                                        // image: AssetImage(
                                        //   "./assets/logo.png",
