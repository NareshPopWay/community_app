...
import '../../../controllers/Request_controller/other_request_controller.dart';


class OtherRequestScreen extends GetView<OtherRequestController> {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
      ...
      body: controller.isLoading.value ? Center(
          ...
          : controller.otherRequestList.isEmpty
          ? Center(
        child: Text(
          'Other Request\'s Not Available',
          style: TextStyle(
            color: Colors.black,
          ...
          itemCount: controller.otherRequestList.length,
          itemBuilder: (BuildContext ctx, index) {
            return  Padding(
              ...
              child: Card(
                ...
                child: InkWell(
                  onTap: () {
                    Get.toNamed(Routes.requestDetail,arguments:controller.otherRequestList[index]);
                  },
                  child: Row(
                    children: <Widget>[
                      Expanded(
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(
                                          BaseUrl.ImageURL +
                                             controller.otherRequestList[index]
                                                  .fileData,
                                        ),
                                        // image: AssetImage(
                                        //   "./assets/logo.png",
