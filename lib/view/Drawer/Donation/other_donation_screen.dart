  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
      ...
      body: controller.isLoading.value ? Center(
          ...
          : controller.otherDonationList.isEmpty
          ? Center(
        child: Text(
          'OtherDonation\'s Not Available',
          style: TextStyle(
            color: Colors.black,
          ...
          itemCount: controller.otherDonationList.length,
          itemBuilder: (BuildContext ctx, index) {
            return  Padding(
              ...
              child: Card(
                ...
                child: InkWell(
                  onTap: () {
                    Get.toNamed(Routes.donationDetail,arguments:controller.otherDonationList[index]);
                  },
                  child: Row(
                    children: <Widget>[
                      Expanded(
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(
                                          BaseUrl.ImageURL +
                                              controller.otherDonationList[index]
                                                  .fileData,
                                        ),
                                        // image: AssetImage(
                                        //   "./assets/logo.png",
