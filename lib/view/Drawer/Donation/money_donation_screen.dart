...
class MoneyDonationScreen extends GetView<MoneyDonationController> {
  const MoneyDonationScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
      ...
      body: controller.isLoading.value ? Center(
          ...
          : controller.moneyDonationList.isEmpty
          ? Center(
        child: Text(
          'MoneyDonation\'s Not Available',
          style: TextStyle(
            color: Colors.black,
          ...
          itemCount: controller.moneyDonationList.length,
          itemBuilder: (BuildContext ctx, index) {
            return  Padding(
              ...
              child: Card(
                ...
                child: InkWell(
                  onTap: () {
                    Get.toNamed(Routes.donationDetail,arguments:controller.moneyDonationList[index]);
                  },
                  child: Row(
                    children: <Widget>[
                      Expanded(
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(
                                          BaseUrl.ImageURL +
                                              controller.moneyDonationList[index]
                                                  .fileData,
                                        ),
                                        // image: AssetImage(
                                        //   "./assets/logo.png",
                                                ...
                                                Flexible(
                                                  child: Text(
                                                    controller.moneyDonationList[index]
                                                        .aboutDonation
                                                        != null
                                                        ? controller.moneyDonationList[index].aboutDonation.length <= 2 ?
                                                          controller.moneyDonationList[index].aboutDonation
                                                        :  "${controller.moneyDonationList[index]
