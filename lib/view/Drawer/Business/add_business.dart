...
class AddBusinessScreen extends GetView<AddBusinessController> {
            ...
            child: Form(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  dropDwonWidget(
                    list: controller.businessTypeList.value,
                    selectedValue: controller.selectedBusinessType,
                    selectedId: controller.selectedBusinessTypeId,
                    emptyTitle: "Select BusinessType",
                    isExpanded: controller.isBusinessTypeExpanded,
                  ),
                  SizedBox(
                    height: 15.0,
                  ),
                  ...
                  if (controller.isLoading.value == false)
                    GestureDetector(
                        ...
                        if (controller.key.currentState!.validate()) {
                          ...
                          if(controller.selectedFile.value == null){
                            ...
                            Fluttertoast.showToast(
                                ...
                                fontSize: 16.0);
                          }else if(controller.selectedBusinessType.value.isEmpty){
                            controller.isLoading.value = false;
                            Fluttertoast.showToast(
                                msg: "Please select BusinessType",
                                toastLength: Toast.LENGTH_SHORT,
                                gravity: ToastGravity.CENTER,
                                timeInSecForIosWeb: 1,
                                backgroundColor: Colors.red,
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Add Business", style: GoogleFonts.aBeeZee(fontSize: 18.0, fontWeight: FontWeight.bold, color: Colors.white),),
                        ),
                      ),
                    )
