...
import '../../../controllers/FamilyMemberController/familymember_detail_controller.dart';


class FamilyMemberDetailsScreen extends GetView<FamilyMemberDetailController> {
  const FamilyMemberDetailsScreen({Key? key}) : super(key: key);
